...
public class JavaSeleniumTest {
	...
	public List<String> getItemName2() {
		...
		try {
			...
			for (int i = 0; i < row1; i++) {
				...
				// 각 사이트 별 주소를 가져온다
				String data = driver.findElement(By.xpath("//*[@id=\"_topItems1\"]/tr[" + (i + 1) + "]/th/a"))
						.getAttribute("href");
				...
				String code = data.substring(index + 1).trim(); // substring - 문자열 자르기(=split), .trim() 문자열 앞 뒤의 공백을
																// 제거함.
	...
	public void getItemInfo2(List<String> resultList2) {
		...
		for (String code : resultList2) {
			...
			// String 차트 =
			// driver.findElement(By.xpath("//*[@id=\"chart_area\"]")).getScreenshotAs(OutputType("./png"));
			...
			try {
				File scrFile = ((TakesScreenshot) driver.findElement(By.xpath("//*[@id=\"chart_area\"]")))
						.getScreenshotAs(OutputType.FILE);
				FileUtils.copyFile(scrFile,
						new File("D:/workspace/java/base/src/project/주식 차트/TOP 거래상위/" + i + "." + 종목이름 + ".png"));
			} catch (IOException e) {
				e.printStackTrace();
			}
			// 투자 정보의 첫 칸의 갯수가 2개인 종목에 대한 출력.
			if (size == 2) {
				String 시가총액 = driver.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[1]/table/tbody/tr[1]/td"))
						.getText();
				System.out.println("시가 총액: " + 시가총액);

				String 상장주식수 = driver.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[1]/table/tbody/tr[2]/td"))
						.getText();
				System.out.println("상장주식수 : " + 상장주식수);

				String ㅣ52주최고52주최저 = driver.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[2]/table/tbody/tr/td"))
						.getText();
				...
				if (종목이름.contains("우드랩")) {
					...
					String 시가총액순위 = driver.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[1]/table/tbody/tr[2]/td"))
							.getText();
					System.out.println("시가 총액순위 : " + 시가총액순위);

					String 상장주식수 = driver.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[1]/table/tbody/tr[3]/td/em"))
							.getText();
					System.out.println("상장 주식수: " + 상장주식수);

					String 외국인한도주식수 = driver.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[2]/table/tbody/tr[1]/td"))
							.getText();
					System.out.println("외국인 한도 주식 수(A): " + 외국인한도주식수);

					String 외국인보유주식수 = driver.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[2]/table/tbody/tr[2]/td"))
							.getText();
					System.out.println("외국인 보유 주식 수(B): " + 외국인보유주식수);

					String 외국인소진율 = driver.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[2]/table/tbody/tr[3]/td"))
							.getText();
					System.out.println("외국인 소진율(B/A): " + 외국인소진율);

					String 투자의견목표주가 = driver.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[3]/table/tbody/tr[1]/td"))
							.getText();
					System.out.println("투자의견 | 목표주가: " + 투자의견목표주가);

					String ㅣ52주최고52주최저 = driver
							.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[3]/table/tbody/tr[2]/td")).getText();
					System.out.println("52주최고 | 52주최저: " + ㅣ52주최고52주최저);

					String PEREPS = driver.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[4]/table/tbody[1]/tr/td"))
							.getText();
					System.out.println("PER|EPS: " + PEREPS);

					String 추정PEREPS = driver
							.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[4]/table/tbody[2]/tr[1]/td")).getText();
					System.out.println("추정 PER|EPS: " + 추정PEREPS);

					String PBRBPS = driver.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[4]/table/tbody[2]/tr[2]/td"))
							.getText();
					System.out.println("PBR|BPS: " + PBRBPS);

					String 배당수익률 = driver.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[4]/table/tbody[2]/tr[3]/td"))
							.getText();
					System.out.println("배당 수익률: " + 배당수익률);

					String 동일업종PER = driver.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[5]/table/tbody/tr[1]/td"))
							.getText();
					System.out.println("동일업종 PER: " + 동일업종PER);

					String 동일업종등락률 = driver.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[5]/table/tbody/tr[2]/td"))
							.getText();
					...
					String ㅣ52주최고52주최저 = driver
							.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[1]/table/tbody/tr[3]/td")).getText();
					System.out.println("52주최고 | 52주최저: " + ㅣ52주최고52주최저);

					String 기초지수 = driver.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[2]/table/tbody/tr[1]/td"))
							.getText();
					System.out.println("기초지수: " + 기초지수);

					String 유형 = driver.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[2]/table/tbody/tr[2]/td"))
							.getText();
					System.out.println("유형: " + 유형);

					String 상장일 = driver.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[2]/table/tbody/tr[3]/td"))
							.getText();
					System.out.println("상장일: " + 상장일);

					String 펀드보수 = driver.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[3]/table/tbody/tr[1]/td"))
							.getText();
					System.out.println("펀드보수: " + 펀드보수);

					String 자산운용사 = driver.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[3]/table/tbody/tr[2]/td"))
							.getText();
					System.out.println("자산운용사: " + 자산운용사);

					String NAV = driver.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[4]/table/tbody/tr[1]/td"))
							.getText();
					System.out.println("NAV: " + NAV);

					String ㅣ1개월수익률 = driver.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[5]/table/tbody/tr[1]/td"))
							.getText();
					System.out.println("1개월 수익률: " + ㅣ1개월수익률);

					String ㅣ3개월수익률 = driver.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[5]/table/tbody/tr[2]/td"))
							.getText();
					System.out.println("3개월 수익률: " + ㅣ3개월수익률);

					String ㅣ6개월수익률 = driver.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[5]/table/tbody/tr[3]/td"))
							.getText();
					System.out.println("6개월 수익률: " + ㅣ6개월수익률);

					String ㅣ1년수익률 = driver.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[5]/table/tbody/tr[4]/td"))
							.getText();
				...
				String 액면가매매단위 = driver.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[1]/table/tbody/tr[4]/td"))
						.getText();
				...
				String ㅣ52주최고52주최저 = driver.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[3]/table/tbody/tr[2]/td"))
						.getText();
				System.out.println("52주최고 | 52주최저: " + ㅣ52주최고52주최저);
				...
				String 추정PEREPS = driver.findElement(By.xpath("//*[@id=\"tab_con1\"]/div[4]/table/tbody[2]/tr[1]/td"))
						.getText();
				System.out.println("추정 PER|EPS: " + 추정PEREPS);
	...
	public List<String> getItemName3() {
		...
		try {
			...
			for (int i = 0; i < row; i++) {
				// Element(요소)의 속성값을 가져오는 .getAttribute를 사용하여 순위별 값을 가져옴
				// 각 사이트 별 주소를 가져온다.
				String data = driver.findElement(By.xpath("//*[@id=\"_topItems2\"]/tr[" + (i + 1) + "]/th/a"))
						.getAttribute("href");
				// 각 사이트는 https://finance.naver.com/item/main.naver?code=000000 으로 나오는데
				int index = data.lastIndexOf("="); // "="을 기준으로 뒤에 있는 숫자 6자리만 가져오도록 설정한다.
				String code = data.substring(index + 1).trim(); // substring - 문자열 자르기 (=split) , .trim() 문자열 앞 뒤의 공백을
		...
		for (String code : resultList3) {
			...
			try {
				File scrFile = ((TakesScreenshot) driver.findElement(By.xpath("//*[@id=\"chart_area\"]")))
						.getScreenshotAs(OutputType.FILE);
				FileUtils.copyFile(scrFile,
						new File("D:/workspace/java/base/src/project/주식 차트/TOP 상승/" + i + "." + 종목이름 + ".png"));
			} catch (IOException e) {
				e.printStackTrace();
			}
			if (size == 2) {
	...
	public List<String> getItemName4() {
		...
		try {
			...
			for (int i = 0; i < row; i++) {
				// Element(요소)의 속성값을 가져오는 .getAttribute를 사용하여 순위별 값을 가져옴
				// 각 사이트 별 주소를 가져온다.
				String data = driver.findElement(By.xpath("//*[@id=\"_topItems3\"]/tr[" + (i + 1) + "]/th/a"))
						.getAttribute("href");
				// 각 사이트는 https://finance.naver.com/item/main.naver?code=000000 으로 나오는데
				int index = data.lastIndexOf("="); // "="을 기준으로 뒤에 있는 숫자 6자리만 가져오도록 설정한다.
				String code = data.substring(index + 1).trim(); // substring - 문자열 자르기 (=split) , .trim() 문자열 앞 뒤의 공백을
		...
		for (String code : resultList4) {
			...
			try {
				File scrFile = ((TakesScreenshot) driver.findElement(By.xpath("//*[@id=\"chart_area\"]")))
						.getScreenshotAs(OutputType.FILE);
				FileUtils.copyFile(scrFile,
						new File("D:/workspace/java/base/src/project/주식 차트/TOP 하락/" + i + "." + 종목이름 + ".png"));
			} catch (IOException e) {
				e.printStackTrace();
			}
	...
	public List<String> getItemName() {
		...
		try {
			...
			for (int i = 0; i < row; i++) {
				// Element(요소)의 속성값을 가져오는 .getAttribute를 사용하여 순위별 값을 가져옴
				// 각 사이트 별 주소를 가져온다.
				String data = driver.findElement(By.xpath("//*[@id=\"_topItems4\"]/tr[" + (i + 1) + "]/th/a"))
						.getAttribute("href");
				// 각 사이트는 https://finance.naver.com/item/main.naver?code=000000 으로 나오는데
				int index = data.lastIndexOf("="); // "="을 기준으로 뒤에 있는 숫자 6자리만 가져오도록 설정한다.
				String code = data.substring(index + 1).trim(); // substring - 문자열 자르기 (=split) , .trim() 문자열 앞 뒤의 공백을
		...
		for (String code : resultList) {
			...
			try {
				File scrFile = ((TakesScreenshot) driver.findElement(By.xpath("//*[@id=\"chart_area\"]")))
						.getScreenshotAs(OutputType.FILE);
				FileUtils.copyFile(scrFile,
						new File("D:/workspace/java/base/src/project/주식 차트/TOP 시가총액 상위/" + i + "." + 종목이름 + ".png"));
			} catch (IOException e) {
				e.printStackTrace();
			}
			if (size == 2) {
